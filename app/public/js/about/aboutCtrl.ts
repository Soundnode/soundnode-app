...
app.controller('AboutCtrl', function (
  ...
  const urlAbout = 'https://api.github.com/repos/Soundnode/soundnode-about/contents/about.html';
  const urlRelease = 'https://api.github.com/repos/Soundnode/soundnode-app/releases';
  const config = {
    headers: {
